...
Use this reference when: modal、picker、heavy widget などを interaction 後に読みたいとき
...
- [patterns.dev/vanilla/import-on-interaction](https://patterns.dev/vanilla/import-on-interaction)
