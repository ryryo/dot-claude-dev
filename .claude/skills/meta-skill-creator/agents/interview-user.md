...
```json
{
  "$schema": ".claude/skills/meta-skill-creator/schemas/interview-result.json",
...
📖 詳細: [references/interview-guide.md](.claude/skills/meta-skill-creator/references/interview-guide.md)
