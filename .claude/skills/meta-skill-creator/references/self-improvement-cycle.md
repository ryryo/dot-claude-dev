...
- **エージェント**: See [agents/analyze-feedback.md](.claude/skills/meta-skill-creator/agents/analyze-feedback.md)
- **エージェント**: See [agents/design-self-improvement.md](.claude/skills/meta-skill-creator/agents/design-self-improvement.md)
- **エージェント**: See [agents/save-patterns.md](.claude/skills/meta-skill-creator/agents/save-patterns.md)
- **スクリプト**: See [scripts/collect_feedback.js](.claude/skills/meta-skill-creator/scripts/collect_feedback.js)
- **スキーマ**: See [schemas/feedback-record.json](.claude/skills/meta-skill-creator/schemas/feedback-record.json)
