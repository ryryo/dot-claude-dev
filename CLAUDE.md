...
| スキル                      | 用途                                                                                                                                                                                       |
| --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **dev:team-plan**           | ストーリーからチーム実行計画を作成。ストーリー分析・タスク分解は native 実行、レビューのみ opencode 活用。計画は永続化され複数保持可能。Triggers: /dev:team-plan, チーム計画, team plan       |
...
| `/dev:team-plan`           | チーム実行計画を作成。ストーリー分析・タスク分解（native）→レビュー（opencode）→承認 |
