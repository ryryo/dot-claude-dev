...
| スキル                      | 用途                                                                                                                                                           |
| --------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **dev:team-opencode-plan**  | ストーリーからチーム実行計画を作成。opencode でストーリー分析・タスク分解・レビュー。計画は永続化され複数保持可能。Triggers: /dev:team-opencode-plan, チーム計画 |
...
| `/dev:team-opencode-plan`  | チーム実行計画を作成。ストーリー分析→タスク分解→レビュー→承認               |
